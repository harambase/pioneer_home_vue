<template>
  <div class="animated fadeIn">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-4 timing">
            ...
            <div class="help">
              <a href="#" class="btn btn-default btn-default_2 pull-left" data-toggle="modal"
    ...
    <div class="stats">
      <div class="container">
        <p class="slideanim">Lorem Ipsum comes from sections 1.10.32 and 1.10.33 of "de Finibus Bonorum et Malorum" (The
          ...
          <div v-for="(item, index) in staffList" :key="item.id">
            <div class="main-box" v-if="item.type === 'f'">
              ...
              <a v-else target="_blank" :href="'/faculty_staff/single?name=' + item.id" class="team-icon">
                <img :src="'/static/images/organization/' + item.id +'_2.jpg'" :alt="item.name">
              </a>
